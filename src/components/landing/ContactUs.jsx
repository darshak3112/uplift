export function ContactUs() {
  return (
    <section
      id="landingContactUs"
      class="text-gray-600 mx-5 body-font relative"
    >
      <h2 className="mb-8 text-3xl font-extrabold leading-tight tracking-tight text-center text-gray-900 dark:text-white md:text-4xl">
        Contact Us
      </h2>
        ...
        <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          ...
          <div class="bg-white relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a class="text-blue-500 leading-relaxed">support@uplift.com</a>
              <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">
                PHONE
              </h2>
              <p class="leading-relaxed">999-777-7890</p>
            </div>
          </div>
        </div>
